...
local Library = {
    ...
    FontColor = Color3.fromRGB(240, 240, 255); -- светлый текст
    MainColor = Color3.fromRGB(30, 32, 40); -- основной фон
    BackgroundColor = Color3.fromRGB(22, 24, 32); -- фон окон
    AccentColor = Color3.fromRGB(0, 180, 255); -- яркий акцент
    OutlineColor = Color3.fromRGB(60, 70, 90); -- границы
    RiskColor = Color3.fromRGB(255, 80, 80);

    Black = Color3.fromRGB(10, 10, 20);
    Font = Enum.Font.GothamSemibold; -- современный шрифт
...
function Library:SetWatermark(Text)
    ...
    Library.Watermark.Size = UDim2.new(0, X + 20, 0, (Y * 1.5) + 8)
    Library:SetWatermarkVisibility(true)
    Library.WatermarkText.Text = Text
    Library.Watermark.BackgroundTransparency = 0.18
    Library.Watermark.BackgroundColor3 = Color3.fromRGB(40, 50, 70)
    local corner = Instance.new('UICorner', Library.Watermark)
...
function Library:Notify(Text, Time)
    ...
    Library:AnimateAppear(NotifyOuter)
    task.spawn(function()
        wait(Time or 5)
        Library:AnimateDisappear(NotifyOuter)
        NotifyOuter:Destroy()
    end)
end
